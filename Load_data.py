...
class PackNumericFeatures(object):
    ...
    def __call__(self, features, labels):
        numeric_features = [features.pop(name) for name
                            in self.names]
...
print('numeric_column: {}'.format(numeric_column))

print('example_batch[numeric]: {}'.format(
    example_batch['numeric']))

numeric_layer = tf.keras.layers.DenseFeatures(
    numeric_columns)
print('Try 1: \n{}'.format(numeric_layer(example_batch)))
...
CATEGORIES = {
    ...
    'deck': ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H',
             'I', 'J'],
    'embark_town': ['Cherbourg', 'Southhampton',
                    'Queenstown'],
    'alone': ['y', 'n']}
...
print('preprocessing_layer: {}'.format(
